...
use crate::worldstate::damage_type::DamageType;
...
mod test_weapon {
    ...
    use crate::worldstate::items::weapon::Weapon;

    #[rstest]
    fn test_weapon_query_primary(
        #[files("src/worldstate/fixtures/weapon_ranged.json")]
        #[mode = str]
    ...
    fn test_weapon_query_melee(
        #[files("src/worldstate/fixtures/weapon_melee.json")]
        #[mode = str]
        melee_weapon_en: &str,
    ) -> Result<(), Box<dyn std::error::Error>> {
